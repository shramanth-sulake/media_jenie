        ...
        <div className="w-100 bg-white py-5 d-flex flex-column align-items-center">
            <div className="container px-4 py-5" style={{ maxWidth: '1000px' }}>
                <div className="text-center mb-5">
                    <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '3rem', lineHeight: '1.25', letterSpacing: '-0.02em', color: '#2b2b2b' }}>
                        Capability: Your extended-team <br className="d-none d-md-block" /> for reliable lead-generation
                    </h2>
                    <p className="text-dark" style={{ fontSize: '1.3rem', color: '#333', fontWeight: '500' }}>
                ...
                <div className="row g-4 mb-5 pt-3">
                    ...
                    <div className="col-12 col-md-4">
                        <div className="pe-md-3">
                            <h4 className="fw-bold mb-2 text-dark" style={{ fontSize: '1.4rem', color: '#333' }}>Phase 01</h4>
                            <h5 className="fw-bold mb-4 text-dark" style={{ fontSize: '1.35rem', color: '#333', lineHeight: '1.4' }}>
                                Discovery + <br />
                                Strategy & Planning
                            </h5>
                    ...
                    <div className="col-12 col-md-4 position-relative">
                        ...
                        <div className="ps-md-4">
                            <h4 className="fw-bold mb-2 text-dark" style={{ fontSize: '1.4rem', color: '#333' }}>Phase 02</h4>
                            <h5 className="fw-bold mb-4 text-dark" style={{ fontSize: '1.35rem', color: '#333', lineHeight: '1.4' }}>
                    ...
                    <div className="col-12 col-md-4 position-relative">
                        ...
                        <div className="ps-md-4">
                            <h4 className="fw-bold mb-2 text-dark" style={{ fontSize: '1.4rem', color: '#333' }}>Phase 03</h4>
                            <h5 className="fw-bold mb-4 text-dark" style={{ fontSize: '1.35rem', color: '#333', lineHeight: '1.4' }}>
                                Activation & <br />
                                Management
                            </h5>
